...
<head>
	...
	<title>Single Post - Rihannon Ozroth</title>
...
<body>
	<div id="header">
		<h1><a href="index.php">Rihannon Ozroth</span></a></h1>
		<ul id="navigation">
			<li>
	...
	<div id="body">
		...
		<div class="content">
			<div class="article">
				...
				<img src="images/lying-yoga2.jpg" alt="">
				<p>
			...
			<div class="sidebar">
				...
				<ul>
					<li>
						<h4><a href="singlepost.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, </a></h4>
